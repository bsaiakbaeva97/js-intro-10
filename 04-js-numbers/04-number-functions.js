...
console.log((123.23).toFixed(1)); // 123.2 // rounds up and give certain number of decimal
console.log((123.23).toPrecision(3)); // 123 // rounds up and gives you the certain number
